  ...
  return (
    <div style={{ minHeight: "calc(100vh - 80px)", display: "flex", flexDirection: "column" }}>
      <div style={{ flex: 1, textAlign: "center", padding: "2rem" }}>
        <h1 style={{ marginBottom: "2rem", fontSize: "2.25rem", color: "hsl(var(--primary))", fontWeight: 800 }}>🍋 DailyWiser Farcaster</h1>
  ...
  if (connected) {
    return (
      <div style={{
        ...
        <div>{publicKey?.toString().substring(0, 6)}...{publicKey?.toString().substring(publicKey.toString().length - 4)}</div>
      </div>
    );
  }
...
function AuthenticationPrompt({
  ...
  return (
    <div style={{ margin: "2rem 0", padding: "3rem", backgroundColor: "#f9f9f9", borderRadius: "16px", maxWidth: "600px", marginLeft: "auto", marginRight: "auto" }}>
      <h3 style={{ fontSize: "1.65rem", marginBottom: "1rem", fontWeight: 800 }}>Welcome to DailyWiser Farcaster!</h3>
