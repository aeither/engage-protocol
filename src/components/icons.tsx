...
export function Trophy({ className = "h-4 w-4" }: { className?: string }) {
  return (
    <svg className={className} viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2">
      ...
      <path d="M4 22h16"/>
      <path d="M10 14.66V17c0 .55.47.98.97 1.21C12.04 18.75 14 20 14 20"/>
      <path d="M14 14.66V17c0 .55-.53.98-1.03 1.21C11.96 18.75 10 20 10 20"/>
...
export function Filter({ className = "h-4 w-4" }: { className?: string }) {
  return (
    <svg className={className} viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2">
...
export function Ticket({ className = "h-4 w-4" }: { className?: string }) {
  return (
    <svg className={className} viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2">
...
export function Crown({ className = "h-4 w-4" }: { className?: string }) {
  return (
    <svg className={className} viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2">
      <path d="M11.562 3.266a.5.5 0 0 1 .876 0L14.75 8.5l4.657-2.328a.5.5 0 0 1 .698.65L18.787 15H5.213L3.895 6.822a.5.5 0 0 1 .698-.65L9.25 8.5l2.312-5.234Z"/>
      <path d="M5 15h14l-.68 3.4a2 2 0 0 1-1.96 1.6H7.64a2 2 0 0 1-1.96-1.6L5 15Z"/>
    </svg>
  );
}
...
export function Repeat({ className = "h-4 w-4" }: { className?: string }) {
  return (
    <svg className={className} viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2">
      <path d="M21 2v6h-6"/>
...
export function User({ className = "h-4 w-4" }: { className?: string }) {
  return (
    <svg className={className} viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2">
...
export function Link({ className = "h-4 w-4" }: { className?: string }) {
  return (
    <svg className={className} viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2">
...
export function Unlink({ className = "h-4 w-4" }: { className?: string }) {
  return (
    <svg className={className} viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2">
      <path d="M18.84 12.25l1.72-1.71h-.02a5.004 5.004 0 0 0-.12-7.07 5.006 5.006 0 0 0-8.4 0l-1.72 1.71"/>
      <path d="M5.17 11.75l-1.71 1.71a5.004 5.004 0 0 0 .12 7.07 5.006 5.006 0 0 0 8.4 0l1.71-1.71"/>
